                ...
                <div className="space-y-2 text-xs">
                  ...
                  >
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="text-[10px] font-semibold bg-teal-600/15 text-teal-700 dark:text-teal-300 px-1.5 py-0.5 rounded group-hover:bg-teal-600 group-hover:text-white transition-colors">
                        Xem DS &gt;
                      </span>
                    </div>
                  </button>
                  ...
                  >
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="text-[10px] font-semibold bg-rose-600/15 text-rose-700 dark:text-rose-300 px-1.5 py-0.5 rounded group-hover:bg-rose-600 group-hover:text-white transition-colors">
                        Xem DS &gt;
                      </span>
                    </div>
                  </button>
                  ...
                  >
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="text-[10px] font-semibold bg-slate-600/15 text-slate-700 dark:text-slate-300 px-1.5 py-0.5 rounded group-hover:bg-slate-600 group-hover:text-white transition-colors">
                        Xem DS &gt;
                      </span>
                    </div>
                  </button>
