        ...
        {loading ? (
          ...
          <div className="space-y-4">
            {invoices.map((inv) => {
              ...
              return (
                <div key={inv.id} className="p-6 rounded-2xl bg-white border border-slate-200/90 shadow-sm">
                  ...
                  <div className="grid grid-cols-3 gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200 text-xs text-center">
                    <div>
                      <p className="text-slate-500 font-medium">Học Phí Phải Đóng</p>
                      <p className="text-sm font-bold text-slate-900 mt-1">
                        {Number(inv.soTienPhaiTra).toLocaleString()} đ
                      </p>
                    </div>
                    <div>
                      <p className="text-slate-500 font-medium">Số Tiền Đã Đóng</p>
                      <p className="text-sm font-bold text-emerald-700 mt-1">
                        {Number(inv.soTienDaTra).toLocaleString()} đ
                      </p>
                    </div>
                    <div>
                      <p className="text-slate-500 font-medium">Còn Nợ</p>
