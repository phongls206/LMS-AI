...
async function main() {
  ...
  const studentData = [
    ...
    // Thêm 20 học viên từ HV011 -> HV030
    ...
    { user: 'student21', ma: 'HV021', ten: 'Mai Tiến Đạt', cefr: TrinhDoCEFR.A2, dob: '2002-01-25', gender: 'Nam', phone: '0904444021', email: 'dat.mai@gmail.com', source: 'TOEIC đầu vào 380', schedule: { thu: [3, 5, 7], gio: '19:00-21:00' } },
    { user: 'student22', ma: 'HV022', ten: 'Trịnh Khánh Huyền', cefr: TrinhDoCEFR.A2, dob: '2003-05-18', gender: 'Nữ', phone: '0904444022', email: 'huyen.trinh@gmail.com', source: 'TOEIC Placement Test', schedule: { thu: [3, 5, 7], gio: '19:00-21:00' } },
    { user: 'student23', ma: 'HV023', ten: 'Phan Tuấn Kiệt', cefr: TrinhDoCEFR.A2, dob: '2001-10-12', gender: 'Nam', phone: '0904444023', email: 'kiet.phan@gmail.com', source: 'Đánh giá năng lực A2', schedule: { thu: [3, 5, 7], gio: '19:00-21:00' } },
    { user: 'student24', ma: 'HV024', ten: 'Lâm Bích Loan', cefr: TrinhDoCEFR.A2, dob: '2004-04-08', gender: 'Nữ', phone: '0904444024', email: 'loan.lam@gmail.com', source: 'Học viên chuyển lớp', schedule: { thu: [3, 5, 7], gio: '19:00-21:00' } },
    
    { user: 'student25', ma: 'HV025', ten: 'Võ Minh Nhật', cefr: TrinhDoCEFR.A1, dob: '2005-02-17', gender: 'Nam', phone: '0904444025', email: 'nhat.vo@gmail.com', source: 'Mất gốc tiếng Anh', schedule: { thu: [3, 5], gio: '17:30-19:30' } },
    { user: 'student26', ma: 'HV026', ten: 'Đoàn Kim Oanh', cefr: TrinhDoCEFR.A1, dob: '2004-12-29', gender: 'Nữ', phone: '0904444026', email: 'oanh.doan@gmail.com', source: 'Bắt đầu từ con số 0', schedule: { thu: [3, 5], gio: '17:30-19:30' } },
    { user: 'student27', ma: 'HV027', ten: 'Tạ Hoàng Phúc', cefr: TrinhDoCEFR.A1, dob: '2003-08-14', gender: 'Nam', phone: '0904444027', email: 'phuc.ta@gmail.com', source: 'Học viên A1 mới', schedule: { thu: [3, 5], gio: '17:30-19:30' } },

    { user: 'student28', ma: 'HV028', ten: 'Quách Thái Sơn', cefr: TrinhDoCEFR.B2, dob: '2000-09-03', gender: 'Nam', phone: '0904444028', email: 'son.quach@gmail.com', source: 'IELTS 6.0', schedule: { thu: [2, 4], gio: '18:00-21:00' } },
    { user: 'student29', ma: 'HV029', ten: 'Nghiêm Thu Trang', cefr: TrinhDoCEFR.B2, dob: '2001-03-27', gender: 'Nữ', phone: '0904444029', email: 'trang.nghiem@gmail.com', source: 'IELTS 6.5 Mock Test', schedule: { thu: [2, 4], gio: '18:00-21:00' } },
    { user: 'student30', ma: 'HV030', ten: 'Lưu Quang Vinh', cefr: TrinhDoCEFR.C1, dob: '1999-11-19', gender: 'Nam', phone: '0904444030', email: 'vinh.luu@gmail.com', source: 'IELTS 7.5 BC Test', schedule: { thu: [2, 4, 6], gio: '18:30-21:30' } },
  ];
  ...
  // ============================================================================
  // Lớp 1: IELTS-B1-01 (Lớp đông 12-15 học viên để test full lớp!)
  const class1 = await prisma.lopHoc.upsert({
    where: { maLopHoc: 'IELTS-B1-01' },
    update: { siSoToiDa: 15, siSoHienTai: 12, trangThai: TrangThaiLopHoc.DANG_HOC },
    create: {
  ...
  const class2 = await prisma.lopHoc.upsert({
    ...
    update: { siSoToiDa: 20, siSoHienTai: 6, trangThai: TrangThaiLopHoc.DANG_HOC },
    create: {
  ...
  const class3 = await prisma.lopHoc.upsert({
    ...
    update: { siSoToiDa: 20, siSoHienTai: 4, trangThai: TrangThaiLopHoc.DANG_HOC },
    create: {
  ...
  const class6 = await prisma.lopHoc.upsert({
    ...
    update: { siSoToiDa: 20, siSoHienTai: 3, trangThai: TrangThaiLopHoc.DANG_MO_DANG_KY },
    create: {
      khoaHocId: course3.id,
  ...
  const enrollAndPay = async (params: {
    ...
    if (params.amountPaid > 0 && params.payCode && params.payMethod) {
      await prisma.thanhToan.upsert({
        where: { maGiaoDich: params.payCode },
        update: {},
        create: {
          hoaDonId: hd.id,
  ...
  // 5.1 Lớp IELTS-B1-01 (12 học viên đăng ký: student01, student05, student11..student20)
  ...
  // 5.2 Lớp TOEIC-A2-01 (6 học viên: student02, student07, student21, student22, student23, student24)
  const class2Students = ['student02', 'student07', 'student21', 'student22', 'student23', 'student24'];
  idx = 1;
  ...
  // 5.3 Lớp COMM-B1-01 (4 học viên: student03, student08, student28, student29)
  const class3Students = ['student03', 'student08', 'student28', 'student29'];
  idx = 1;
  ...
  // 5.5 Lớp IELTS-B2-01 (3 học viên: student06, student09, student30)
  const class5Students = ['student06', 'student09', 'student30'];
  idx = 1;
  ...
  for (const sess of class1Sessions) {
    ...
    for (const sUser of class1Students) {
      const sProfile = studentProfiles[sUser];
      const isAbsent = sUser === 'student15' && sess.so === 4;
      ...
      await prisma.banGhiDiemDanh.create({
        data: {
          ...
          trangThai: attStatus,
          ghiChu: isAbsent ? 'Bận việc gia đình' : isLate ? 'Kẹt xe đến muộn 15p' : 'Đi học đúng giờ',
        },
      });
    }
  }
  ...
  // Điểm số cho học viên lớp IELTS-B1-01
  const class1Grades = [
    ...
    { user: 'student15', cc: 75.0, gk: 60.0, ck: 65.0, total: 65.5, note: 'Cần chú ý đi học chuyên cần hơn để không bị hổng kiến thức.', status: TrangThaiHoanThanh.DAT },
    ...
    { user: 'student17', cc: 85.0, gk: 70.0, ck: 75.0, total: 75.5, note: 'Làm bài tập về nhà đầy đủ.', status: TrangThaiHoanThanh.DAT },
    ...
    { user: 'student19', cc: 80.0, gk: 68.0, ck: null, total: null, note: 'Đang ở giai đoạn giữa khóa, điểm giữa kỳ đạt 68/100.', status: TrangThaiHoanThanh.CHUA_XEP_LOAI },
    { user: 'student20', cc: 85.0, gk: 75.0, ck: null, total: null, note: 'Đang hoàn thành nửa chặng đường khóa học.', status: TrangThaiHoanThanh.CHUA_XEP_LOAI },
  ];
  ...
  const class2Grades = [
    ...
    { user: 'student21', cc: 85.0, gk: 70.0, ck: 72.0, total: 74.0, note: 'Nắm chắc ngữ pháp cơ bản.', status: TrangThaiHoanThanh.DAT },
    { user: 'student22', cc: 88.0, gk: 76.0, ck: 80.0, total: 80.4, note: 'Tiến độ làm bài thi nhanh và chính xác.', status: TrangThaiHoanThanh.DAT },
    { user: 'student23', cc: 80.0, gk: 62.0, ck: 66.0, total: 67.6, note: 'Cần luyện nghe các đoạn hội thoại dài Part 3, 4.', status: TrangThaiHoanThanh.DAT },
  ...
  // Điểm số cho học viên lớp COMM-B1-01
  const class3Grades = [
  ...
  console.log('✅ Đã nạp Bảng điểm chuẩn quy chế');
  ...
  console.log('   📚 Lớp IELTS-B1-01      : 12 Học viên (Lớp đông để test full sĩ số)');
  console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
}
