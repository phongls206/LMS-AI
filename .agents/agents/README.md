...
| **5** | **Frontend UI/UX** | [`frontend-ui-agent.md`](file:///d:/MyProjects/lms-ai/.agents/agents/frontend-ui-agent.md) | Giao diện Next.js App Router, Responsive Mobile/Desktop, In ấn A4 & Trải nghiệm tương tác | `implementation`, `figma-design`, `ui-mockup-designer`, `frontend-design` |
